...
class MenusTableSeeder extends Seeder
{
    ...
    public function beginDropdown($name, $href, $icon){
    ...
    public function run()
    {
        ...
        $this->insertTitle('Components');
        $this->beginDropdown('Base', '/base', 'cui-puzzle');
        ...
        $this->endDropdown();
        $this->beginDropdown('Buttons', '/buttons', 'cui-cursor');
        ...
        $this->beginDropdown('Pages', '/pages', 'cui-star');
